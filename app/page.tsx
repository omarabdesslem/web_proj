...
export default function CV() {
  return (
    <main className="flex p-12 bg-gray-100 text-black">
      {/* Sidebar Navigation */}
      <nav
        className="flex flex-col items-start p-4 bg-white shadow-lg rounded-lg mr-12 w-40 h-220"
        style={{ height: "220px" }}
      >
      ...
      <div className="flex-1">
        ...
        <section id="projects" className="w-full max-w-4xl mb-10">
        ...
        <section id="experiences" className="w-full max-w-4xl mb-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg mb-6 flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p>
                ...
                aimed at enhancing Cantonese and Mandarin language acquisition
                for specially-abled children. Focused on creating user-friendly
                ...
                practices. Gained in-depth knowledge and practical experience
                with the Vue.js ecosystem, including tools like Vue Router and
                Vuex.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p>
                Taught various programming languages and tools to children aged
                5 to 14, including Scratch for beginners, LEGO NXT for
                intermediate robotics projects, and Unreal Engine for advanced
                students. Enhanced communication skills, managed diverse
                classes, and collaborated with other educators to deliver
                engaging programming curricula.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="education" className="w-full max-w-4xl mb-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg mb-6 flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p>
                Studied core subjects including Cryptography, Semantics,
                Networks along with Mathematics and Physics.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p>
                Swiss-International Mobility program, engaged in advanced
                studies and practical applications in Software Engineering, Data
                Mining, AI, Networks & Computer Vision.
              </p>
            </div>
          </div>
        </section>
